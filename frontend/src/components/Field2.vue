...
const addShipToBoard = async (input1, input2) => {
  try {
    ...
    const response = await fetch('https://parental-annabell-mindwork-6d15eec4.koyeb.app/game/player2/addShip', {
      method: 'POST',
      headers: {
...
const fetchGameData = async () => {
  try {
    const response = await fetch('https://parental-annabell-mindwork-6d15eec4.koyeb.app/game/addShips2json');
